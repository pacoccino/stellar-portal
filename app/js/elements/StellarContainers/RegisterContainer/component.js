  ...
  newForm() {
    return (
      <div style={styles.inputCntainer}>
        ...
        <Segment color="blue">
          Please enter your personal informations to register on the exchange platform.
        </Segment>
            ...
            <Grid.Row>
              ...
              <Grid.Column width={11}>
                <Form.Group  widths='equal'>
                  <Form.Input name= "user_name" placeholder='User Name'/>
            ...
            <Grid.Row>
              ...
              <Grid.Column width={11}>
                <Form.Group  widths='equal'>
                  ...
                  <Form.Input name= "passport_nr" placeholder='Passport Number' />
                </Form.Group>
              </Grid.Column>
            </Grid.Row>
            <Grid.Row>
              ...
              <Grid.Column width={11}>
                <Form.Group  widths='equal'>
                  <Form.Input name= "address_nr" placeholder='No.' />
                  <Form.Input name= "street" placeholder='Street'/>
                </Form.Group>
                <Form.Group  widths='equal'>
                  <Form.Input name= "postal_code" placeholder='Postal Code'/>
                  <Form.Input name= "city" placeholder='City'/>
                  <Form.Field>
                    <Dropdown placeholder='Country' search selection options={countryOptions}/>
                  </Form.Field>
                </Form.Group>
                <Form.Field>
